public class Funcionario implements Comparable<Funcionario>{//<T> para criar um parametro na classe, recebe por parametro um tipo T, se deixar <>vazio assume parametro object
    private int matricula;// nem sempre é int,ao inves de ser int, é T
    private String nome;
    ...
    public int compareTo(Funcionario outro){//met compareTo deve retornar 0, >0 ou <0
